...
abstract class AbstractUserGroupTest extends AbstractIntegrationTest {
	
	protected void saveGroup(WebElement tabpanel) {
		clickButton(tabpanel, "save");
		findSuccessMessage();
	}
	
	protected WebElement showGroup(String name) {
