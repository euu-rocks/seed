...
abstract class AbstractFilterTest extends AbstractIntegrationTest {

	protected void saveFilter(WebElement tabpanel) {
		clickButton(tabpanel, "save");
		findSuccessMessage();
	}
	
	protected WebElement showFilter(String name) {
