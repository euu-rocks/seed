...
public class CreateDataSourceTest extends AbstractIntegrationTest {
	...
	void testCreateDataSource() {
		...
		clickTab(tabpanel, "sql");
		WebElement tabpanelSQL = findTabpanel(tabpanel, "sql");
		findCodeMirror(tabpanelSQL, "content", 1).sendKeys("select * from integrationtest where id={id}");
